...
int64 nChainStartTime = 1489222627;
...
const string strMessageMagic = "fibocoins2.0 Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nHeight > 1)
       ...
       nSubsidy = 660000 * COIN; //Premin: 1000M
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in fibocoins2.0
    bool fStrictPayToScriptHash = true; // Always active in fibocoins2.0
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fibocoins2.0", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = " Sep 21 2016. The fibocoins2.0 is upcoming release. wish is a great coin.";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x2c2ddce55dea38d1d33fc55fe5372b1f5b11f0facad649a2dbc77105068c74b3"));
...
unsigned char pchMessageStart[4] = { 0x43, 0x25, 0x24, 0x32 };
