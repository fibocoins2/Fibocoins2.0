...
{
    resize(850, 550);
    setWindowTitle(tr("fibocoins2.0") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a fibocoins2.0 address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About fibocoins2.0"), this);
    aboutAction->setToolTip(tr("Show information about fibocoins2.0"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for fibocoins2.0"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("fibocoins2.0 client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("fibocoins2.0 client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to fibocoins2.0 network.", "", count));
}
...
{
    const QUrl url("http://119.29.112.46");
...
{
    const QUrl url("http://www.fibocoins2.0.com");
    QDesktopServices::openUrl(url);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid fibocoins2.0 address or malformed URI parameters."));
    }
